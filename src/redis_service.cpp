...
DEFINE_string(tx_service_data_path, "", "path for tx_service raft data");
DEFINE_string(log_service_data_path, "", "path for log_service raft data");
    ...
    else
    {
        ...
        if (!skip_wal_)
        {
            ...
            txlog_rocksdb_cloud_config.aws_access_key_id_ =
                config_reader.GetString("store", "aws_access_key_id", "test");
            txlog_rocksdb_cloud_config.aws_secret_key_ =
                config_reader.GetString("store", "aws_secret_key", "test");
